<%@ Page Language="C#" MasterPageFile="JefeOdontologico.Master" AutoEventWireup="true" CodeBehind="Asistentes.aspx.cs" Inherits="SoftGestWA.Views.JefeOdontologico.Asistentes" %>
        ...
        <div class="card w-100 border-0 shadow-none rounded-0">
            <div class="card-body px-4 py-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h3 class="fw-semibold mb-0">Asistentes de Mostrador</h3>
                    <asp:Button ID="btnNuevo" runat="server" CssClass="btn btn-primary"
                        Text="+ Nuevo Asistente" OnClick="btnNuevo_Click" />
                </div>
