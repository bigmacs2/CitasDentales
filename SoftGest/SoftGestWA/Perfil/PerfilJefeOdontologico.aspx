<%@ Page Language="C#" MasterPageFile="~/Views/JefeOdontologico/JefeOdontologico.Master" AutoEventWireup="true" CodeBehind="PerfilJefeOdontologico.aspx.cs" Inherits="SoftGestWA.Perfil.PerfilJefeOdontologicoPage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container" style="padding-top: 0; overflow-x: hidden;">
        <h2 style="margin-top: -10px; margin-bottom: 1rem; margin-left: 0; text-align: left;">Perfil de Jefe Odontológico</h2>
